...
def main(fileName1,fileName2,fileName3):
    ...
    # Create transfer mapping scalar value to color.
    colorTransferFunction3 = vtk.vtkColorTransferFunction()
    for pixelVal in linspace(120,255):
        rgba = mapper.to_rgba(pixelVal)
        colorTransferFunction3.AddRGBPoint( pixelVal , rgba[0], rgba[1], rgba[2])
    ...
    volumeProperty3.SetColor(colorTransferFunction3)
    volumeProperty3.SetScalarOpacity(opacityTransferFunction1)
    volumeProperty3.SetInterpolationTypeToLinear()
    volumeProperty3.SetGradientOpacity(volumeGradientOpacity1)
    ...
    volumeMapper3.SetInputConnection(reader3.GetOutputPort())
...
if __name__ == '__main__':
    ...
    fileName1 = '../data/VTKmodel/cnn_Bundle1.vtk'
    fileName2 = '../data/VTKmodel/cnn_Bundle2.vtk'
    fileName3 = '../data/VTKmodel/cnn_Bundle3.vtk'
